...
Route::controller(ImovelController::class)->group(function () {
    Route::get('/imovel', 'index')->name('imovel.index')->middleware('CheckAdmin');
    Route::get('/imovel/create', 'create')->name('imovel.create');
    Route::post('/imovel/salvar', 'store')->name('imovel.store');
    Route::get('/imovel/{imovel}/aprovar', 'aprovar')->name('imovel.aprovar')->middleware('CheckAdmin');
    Route::delete('/imovel/{imovel}/delete', 'destroy')->name('imovel.destroy');
...
Route::controller(AnuncioController::class)->group(function () {
    ...
    Route::get('/anuncio/editar/{id}', 'editar')->name('anuncio.editar');
    Route::get('/anuncios', [AnuncioController::class, 'anuncios'])->name('anuncio.anuncios');
    ...
    Route::post('/anuncio/store', 'store')->name('anuncio.store')->middleware('CheckVendedor');
    Route::post('/anuncio/update', 'update')->name('anuncio.update')->middleware('CheckVendedor');
    Route::post('/anuncio/contato', 'contato')->name('anuncio.contato')->middleware('auth');
    Route::post('/anuncio/definecomprador', 'definecomprador')->name('anuncio.definecomprador')->middleware('CheckVendedor');
});
